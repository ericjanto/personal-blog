...
I had to achieve two things: first of all, to not bionicify the frontmatter part of the Markdown file at all. Secondly, to remove, add or change some of the frontmatter fields. I wanted to keep some fields, such as the post title, and delete others, such as the desired URL.
