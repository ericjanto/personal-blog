...
I **ha**d **t**o **achie**ve **tw**o **thin**gs: **fir**st **o**f **al**l, **t**o **no**t **bionici**fy **th**e **frontmatt**er **par**t **o**f **th**e **Markdo**wn **fil**e **a**t **al**l. **Second**ly, **t**o **remo**ve, **ad**d **o**r **chan**ge **som**e **o**f **th**e **frontmatt**er **fiel**ds. I **want**ed **t**o **kee**p **som**e **fiel**ds, **suc**h **a**s **th**e **pos**t **tit**le, **an**d **dele**te **othe**rs, **suc**h **a**s **th**e **desir**ed **UR**L.
